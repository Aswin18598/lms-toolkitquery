...
import { useGetTopCoursesQuery } from "../store";
...
const TopCourses = () => {
	...
	const { isFetching } = useGetTopCoursesQuery({
		AccountID: userDetails.AccountId,
		PageNumber: PageNumber,
		PageSize: PageSize
	});
	const { TopCourses, TopCoursesMessage } = useAppSelector((state: any) => state.AdminDashboardReducer);
