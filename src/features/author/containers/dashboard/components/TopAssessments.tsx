...
import { useGetAuthorTopAssessmentsQuery } from "../store";
...
const TopAssessment = () => {
	...
	const { isFetching } = useGetAuthorTopAssessmentsQuery({
		AccountID: userDetails.AccountId,
		PageNumber: pageNumber,
		PageSize: pageSize
	});
	const { TopAssessments, TopAssessmentsMessage } = useAppSelector((state: any) => state.AuthorDashboradReducer);
