...
import PaginationAboveFourButton from "./PaginationAboveFourButton";
...
const Pagination = ({ PaginationData, count = 10 }: IProps) => {
	const { isTableView = false } = PaginationData;
			...
			{PaginationData.TotalPages > 0 && (
				<div
					className={`flex flex-col items-center ${
						isTableView ? "" : "rounded-lg mt-5 border"
					} bg-[#FFFFFF]  justify-between space-y-4 px-4 py-4 sm:flex-row sm:items-center sm:space-y-0 sm:px-5`}
				>
